...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn(
      `relative z-10 flex max-w-max flex-1 items-center duration-300 ease-in-out justify-center ${jeju.className} text-lg`,
      className
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(
      'group flex flex-1 list-none items-center justify-center  2md:gap-x-4 gap-x-3',
      className
    )}
    {...props}
  />
